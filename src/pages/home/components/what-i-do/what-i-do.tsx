        ...
        <Container id="what-i-do">
            ...
            <Row>
                ...
                <Col md={{ span: 5, offset: 2 }} className="mt-md-0 mt-5">
                    ...
                    <p>
                        At hackathons, I’ve developed numerous award-winning
                        Internet of Things appliances with scraps of garbage in
                        under 24 hours.
                    </p>
                </Col>
            </Row>
            <Row>
                ...
                >
                    ...
                    <p>
                        I’ve written software for multiple clients since high
                        school. Currently, I write and fix remote learning
                        programs for the USC Marshall School of Business.
                    </p>
                </Col>
                <Col
